...
* #section-patient-contacts "Patient contacts"
* #section-primary-survey "Primary survey"
* #section-stroke-assessments "Stroke assessments"
* #section-falls-risk "Falls risk assessment"
* #section-refusal "Transport/treatment refusal"
* #section-competence "Patient competence"
* #section-clinical-images "Clinical images"
* #incident-event-call-received "Time call received"
* #incident-event-unit-dispatched "Time unit dispatched"
* #incident-event-unit-responded "Time unit responded"
* #incident-event-arrived-scene "Time unit arrived at scene"
* #incident-event-patient-located "Time patient located"
* #incident-event-departed-scene "Time unit departed with patient"
* #incident-event-arrived-destination "Time unit arrived at destination"
* #incident-event-closed "Time incident closed"
* #primary-survey "Primary survey"
* #primary-survey-responsiveness "Responsiveness"
* #primary-survey-airway "Airway"
* #primary-survey-breathing "Breathing"
* #primary-survey-circulation "Circulation"
* #primary-survey-blood-loss "Blood loss"
* #abcd2-assessment "ABCD2 stroke risk assessment"
* #assessment-not-possible "Assessment not possible reason"
* #abcd2-age-60-or-older "Age 60 or older"
* #abcd2-hypertensive "Hypertensive"
* #abcd2-clinical-features "ABCD2 clinical features"
* #abcd2-duration "Duration of symptoms"
* #abcd2-diabetes "Diabetes"
* #abcd2-score "ABCD2 score"
* #fast-assessment "FAST stroke assessment"
* #fast-face "Face"
* #fast-face-laterality "Face laterality"
* #fast-arms "Arms"
* #fast-arms-laterality "Arms laterality"
* #fast-speech "Speech"
* #stroke-onset "Stroke symptom onset"
* #last-seen-well "When last seen well"
* #found-in-condition "Patient found in this condition"
* #receiving-hospital-notified "Receiving hospital notified"
* #falls-risk-assessment "Falls risk assessment"
* #fall-frequency "Fall frequency"
* #avoids-activities "Avoids activities"
* #feet-problem "Feet problem"
* #gait-strength-balance-problem "Gait strength balance problem"
* #uses-aid "Uses an aid"
* #dizziness "Dizziness"
* #cognitive-impairment "Cognitive impairment"
* #trip-hazards "Trip hazards"
* #home-modifications-required "Home modifications required"
* #home-modifications-notes "Home modifications notes"
* #lives-alone "Lives alone"
* #falls-assessment-notes "Falls assessment notes"
* #transport-treatment-refusal "Transport/treatment refusal"
* #treatment-required "Treatment required"
* #transport-required "Transport required"
* #consulted-with "Consulted with"
* #reason-for-refusal "Reason for refusal"
* #consequences-explained "Consequences explained"
* #patient-competence-assessment "Patient competence assessment"
* #understands-treatment-information "Understands treatment information"
* #understands-decision-consequences "Understands decision consequences"
* #remembers-information "Remembers information"
* #self-harm-concern "Self-harm concern"
* #last-oral-intake-detail "Last oral intake detail"
